    ...
    <header className={classNameHeader}>
      ...
      <div className='w-full bg-orange'>
        <div className='container flex h-[5.3125rem] items-center justify-between py-4'>
          <Link title={t('home')} to='/' className='-mt-3 flex items-end gap-2 pr-2 md:pr-10'>
            ...
            <h1 className='hidden text-4xl text-white md:inline-block'>Stride</h1>
          </Link>
          <form
          ...
          >
            ...
            <button
              type='submit'
              className='cursor-pointer rounded-sm bg-orange px-6 py-[10px] outline-none'
            >
          ...
          <div className='mx-0 flex items-center justify-center md:mx-10'>
            <Popover
              renderPopover={
                <div className='w-[25rem] rounded-sm border border-t-0 bg-white text-sm shadow-sm'>
                  {purchaseInCartData ? (
                    <div>
                      <span className='block p-[10px] capitalize text-gray-400'>
            ...
            >
              <Link
                title={t('view my shopping cart')}
                className='relative block px-2 py-4 md:px-6'
                to={path.cart}
              >
